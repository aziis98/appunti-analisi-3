...
\mysection{Esercitazione del 4 ottobre}

\mysubsection{Esercizi di teoria della misura}
...
\mysubsection{Funzioni misurabili rispetto alla misura di Lebesgue}
...
\mysubsection{Formula di cambio di variabile applicata a funzioni radiali}
