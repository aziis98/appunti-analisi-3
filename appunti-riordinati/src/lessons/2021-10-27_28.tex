...
\item Ogni sistema ortonormale $\mc{F}$ si completa a $\wtilde{\mc{F}}$ base di Hilbert di $H$.

\textbf{Dimostrazione.} Sia $X = \left\{ \mc{F} \; \text{sistema ortonormale} H \text{ tale che } \wtilde{\mc{F}} \subset \mc{F} \right\}$.
...
\begin{itemize}
	...
	\item $x \in V \Longrightarrow x \perp x_1 \Longrightarrow x \perp x_0 \Longrightarrow \wtilde{\Lambda} = 0 = \Lambda(x)$. Quindi $\wtilde{\Lambda} = \Lambda$ su $V$.
