...
\begin{itemize}
	\item
		...
		L'idea è di approssimare la classe delle funzioni semplici aventi dominio limitato. Data $f \in \mathscr{S}_l$ la approssimiamo con 
		$$
			f_n \coloneqq  f \cdot \One_{\{|x| < n\} \cap \{\dd(\partial X,x) > 1/n\}}.
		$$
		Resta da verificare che tale successione converge a $f$ in $L^p$.
