...
\textbf{Corollario.} Siano $H$ spazio di Hilbert, $\mc{F} = \left\{ e_n \mymid n \in \N \right\}$ base di Hilbert, $x,x' \in H$. Valgono le seguenti.
\begin{enumerate}
...
\textbf{Teorema 3} (di rappresentazione di Riesz.)} Dato $\Lambda \colon  H \to \R$ lineare e continuo, esiste $x_0 \in H$ tale che 
...
Allora $V^\perp = \spn \left\{ x_1 \right\}$ con $\norm{x_1} = 1$. Definiamo $c \coloneqq \Lambda(x_1)$ e poniamo $x_0 \coloneqq c x_1$.
