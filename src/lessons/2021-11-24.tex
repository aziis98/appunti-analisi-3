...
\textbf{Applicazione.} Risoluzione di EDP su $[0,\pi]$ con condizioni di Dirichlet (omogenee) al bordo.
...
\textit{Passo 3.} Mostriamo che la $u(t,x)$ definita in \eqref{eq:24nov_soluzione_1} risolve \eqref{24nov_problema_1}.
\begin{itemize}
