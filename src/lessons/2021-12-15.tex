...
\textbf{Definizione.} Siano $1 \leq k \leq d$ e $m = 1,2,\ldots$. L'insieme $\Sigma \subset \R^d$ si definisce \textbf{superficie} (senza bordo) di dimensione $k$ e classe $C^m$ se per ogni $x \in \Sigma$ esiste $U$ intorno aperto\footnote{D'ora in avanti gli intorni saranno sempre aperti.} di $x$ ed esiste una mappa $\phi \colon D \to \R^d \in C^m$ con $D$ aperto di $\R^k$ tale che
\begin{itemize}
