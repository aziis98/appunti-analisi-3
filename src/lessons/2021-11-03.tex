...
\textbf{Osservazione.} La continuità di $T$ si può verificare anche usando il teorema di Rietz \textbf{riferimento.}. Infatti,
$$
T(u) 
...
Per il teorema  \textbf{riferimento} abbiamo che $\sigma_\delta g \ast v = \sigma_\delta g \xrightarrow{\delta \to 0} v$ in $L^1(\R)$, ma $\sigma_\delta g \xrightarrow{\delta \to 0} 0$ quasi ovunque in $L^1(\R)$. Allora $v = 0$ q.o. in $L^1(\R)$, dunque non può valere $f \ast v = v$ per ogni $f \in L^1(\R)$.
